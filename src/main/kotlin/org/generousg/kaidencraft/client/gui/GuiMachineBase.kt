...
import org.generousg.fruitylib.client.gui.BaseGuiContainer
import org.generousg.fruitylib.container.ContainerBase
import org.generousg.fruitylib.sync.ISyncMapProvider


abstract class GuiMachineBase<out T : ContainerBase<ISyncMapProvider>>(container: T, width: Int, height: Int, name: String) : BaseGuiContainer<T>(container, width, height, name) {
    companion object {
